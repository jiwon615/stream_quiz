...
public class Quiz4 {
    ...
    public List<Trader> quiz3() {
        List<Trader> result = transactions.stream()
                .map(Transaction::getTrader)
                .distinct()
                .filter(i -> i.getCity().equalsIgnoreCase("Seoul"))
    ...
    public boolean quiz5() {
        boolean result = transactions.stream()
                .map(Transaction::getTrader)
                .anyMatch(i -> i.getCity().equalsIgnoreCase("Busan"));
        return result;
    }
    ...
    public List<Integer> quiz6() {
        List<Integer> result = transactions.stream()
                .filter(i -> i.getTrader().getCity().equalsIgnoreCase("Seoul"))
